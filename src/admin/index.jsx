...
<div class="p-4 sm:ml-4 md:ml-64">
  <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
      <div class="flex items-center justify-center h-auto rounded bg-gray-50 dark:bg-gray-800 shadow-lg bg-sky-500/100">     
      <div class="border-2 border-gray-200 px-4 py-6 rounded-lg w-full flex justify-center flex-col items-center">
...
<div class="flex items-center justify-center h-auto rounded bg-gray-50 dark:bg-gray-800 shadow-lg bg-sky-500/100">     
      <div class="border-2 border-gray-200 px-4 py-6 rounded-lg w-full flex justify-center flex-col items-center">
          ...
          <h2 class="title-font font-medium text-3xl text-gray-900">2.7K</h2>
          <p class="leading-relaxed">Approved Students</p>
        </div>
      </div>
...
<div class="flex items-center justify-center h-auto rounded bg-gray-50 dark:bg-gray-800 shadow-lg bg-sky-500/100">     
      <div class="border-2 border-gray-200 px-4 py-6 rounded-lg w-full flex justify-center flex-col items-center">
          ...
          <h2 class="title-font font-medium text-3xl text-gray-900">2.7K</h2>
          <p class="leading-relaxed">Painding Students</p>
        </div>
      </div>
...
return(
  ...
  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src={e.pic} alt={e.name} />
                    <div class="pl-3">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center">
                        <div class="h-2.5 w-2.5 rounded-full bg-green-500 mr-2"></div>{e.status}
                    </div>
                </td>
                <td class="px-6 py-4">
